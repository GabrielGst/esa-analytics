...
import GenPptx from '../GeneratePPT';
import GenPptxTracking from '../GeneratePPTTracking';
...
export function ActivityTableTracking({
  data,
  rowSelection,
  ...
  const table = useMantineReactTable({
    ...
    initialState: {
      ...
      // columnPinning: { left: ['country', 'supplierName', 'rowSelection'] } 
      // grouping: ['state'],
        ...
        <Flex p="xs" justify="space-between">
          ...
          <Flex justify="space-between">            
            <Flex sx={{ gap: '8px' }} p="xs">
              <GenPptxTracking activityData={data} activitySelection={rowSelection} />
            </Flex>
          </Flex>
        </Flex>
      );
